...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.noteFixTab = QtWidgets.QWidget()
        self.noteFixTab.setObjectName("noteFixTab")
        self.gridLayout_6 = QtWidgets.QGridLayout(self.noteFixTab)
        self.gridLayout_6.setObjectName("gridLayout_6")
        self.noteFixCBGroupBox = QtWidgets.QGroupBox(parent=self.noteFixTab)
        self.noteFixCBGroupBox.setObjectName("noteFixCBGroupBox")
        self.gridLayout_5 = QtWidgets.QGridLayout(self.noteFixCBGroupBox)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.noteFixDefCB = QtWidgets.QCheckBox(parent=self.noteFixCBGroupBox)
        self.noteFixDefCB.setObjectName("noteFixDefCB")
        self.gridLayout_5.addWidget(self.noteFixDefCB, 0, 0, 1, 1)
        self.noteFixSentenceCB = QtWidgets.QCheckBox(parent=self.noteFixCBGroupBox)
        self.noteFixSentenceCB.setObjectName("noteFixSentenceCB")
        self.gridLayout_5.addWidget(self.noteFixSentenceCB, 0, 1, 1, 1)
        self.noteFixPhraseCB = QtWidgets.QCheckBox(parent=self.noteFixCBGroupBox)
        self.noteFixPhraseCB.setObjectName("noteFixPhraseCB")
        self.gridLayout_5.addWidget(self.noteFixPhraseCB, 0, 2, 1, 1)
        self.noteFixImgCB = QtWidgets.QCheckBox(parent=self.noteFixCBGroupBox)
        self.noteFixImgCB.setObjectName("noteFixImgCB")
        self.gridLayout_5.addWidget(self.noteFixImgCB, 0, 3, 1, 1)
        self.noteFixBrEPhoneticCB = QtWidgets.QCheckBox(parent=self.noteFixCBGroupBox)
        self.noteFixBrEPhoneticCB.setObjectName("noteFixBrEPhoneticCB")
        self.gridLayout_5.addWidget(self.noteFixBrEPhoneticCB, 1, 0, 1, 1)
        self.noteFixAmEPhoneticCB = QtWidgets.QCheckBox(parent=self.noteFixCBGroupBox)
        self.noteFixAmEPhoneticCB.setObjectName("noteFixAmEPhoneticCB")
        self.gridLayout_5.addWidget(self.noteFixAmEPhoneticCB, 1, 1, 1, 1)
        self.noteFixPronCB = QtWidgets.QCheckBox(parent=self.noteFixCBGroupBox)
        self.noteFixPronCB.setObjectName("noteFixPronCB")
        self.gridLayout_5.addWidget(self.noteFixPronCB, 1, 2, 1, 1)
        self.gridLayout_6.addWidget(self.noteFixCBGroupBox, 4, 0, 2, 2)
        self.noteFixBtn = QtWidgets.QPushButton(parent=self.noteFixTab)
        self.noteFixBtn.setObjectName("noteFixBtn")
        self.gridLayout_6.addWidget(self.noteFixBtn, 6, 0, 1, 2)
        self.noteFixIntroLabel = QtWidgets.QLabel(parent=self.noteFixTab)
        self.noteFixIntroLabel.setTextFormat(QtCore.Qt.TextFormat.MarkdownText)
        self.noteFixIntroLabel.setObjectName("noteFixIntroLabel")
        self.gridLayout_6.addWidget(self.noteFixIntroLabel, 0, 0, 1, 2)
        self.noteFixProgressGroupBox = QtWidgets.QGroupBox(parent=self.noteFixTab)
        self.noteFixProgressGroupBox.setFlat(False)
        self.noteFixProgressGroupBox.setObjectName("noteFixProgressGroupBox")
        ...
        self.tabWidget.addTab(self.noteFixTab, "")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.noteFixCBGroupBox.setTitle(_translate("Dialog", "修复字段"))
        self.noteFixDefCB.setText(_translate("Dialog", "释义"))
        self.noteFixSentenceCB.setText(_translate("Dialog", "例句"))
        self.noteFixPhraseCB.setText(_translate("Dialog", "短语"))
        self.noteFixImgCB.setText(_translate("Dialog", "图片"))
        self.noteFixBrEPhoneticCB.setText(_translate("Dialog", "英式音标"))
        self.noteFixAmEPhoneticCB.setText(_translate("Dialog", "美式音标"))
        self.noteFixPronCB.setText(_translate("Dialog", "发音"))

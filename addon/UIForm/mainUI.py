...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.congestLabel.setEnabled(False)
        self.congestLabel.setObjectName("congestLabel")
        self.congestLayout.addWidget(self.congestLabel)
        self.congestSpinBox = QtWidgets.QDoubleSpinBox(parent=self.defaultConfigGroupBox)
        self.congestSpinBox.setEnabled(False)
        self.congestSpinBox.setSuffix("")
        self.congestSpinBox.setMinimum(30.0)
        self.congestSpinBox.setMaximum(999.0)
        self.congestSpinBox.setProperty("value", 60.0)
